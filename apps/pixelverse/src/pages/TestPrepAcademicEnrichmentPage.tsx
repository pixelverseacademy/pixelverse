...
const TestPrepAcademicEnrichmentPage: React.FC = () => {
  ...
  const stats = [
    ...
    { number: '5', label: 'Years Teaching Excellence' },
  ];
  const programs = [
    {
      ...
      >
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          ...
          <Typography variant="h5" sx={{ mb: 4, color: 'white', fontFamily: 'Poppins, sans-serif', fontWeight: '600', textShadow: '1px 1px 4px rgba(0, 0, 0, 0.5)' }}>
            Excel Academically with Personalized Support
          </Typography>
          <Typography variant="h6" sx={{ maxWidth: '800px', mx: 'auto', mb: 4, color: 'white', fontFamily: 'Nunito, sans-serif', textShadow: '1px 1px 3px rgba(0, 0, 0, 0.5)' }}>
            Comprehensive test preparation and academic tutoring to help students achieve their highest potential and academic goals.
          </Typography>
